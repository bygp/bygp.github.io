...
<body>
    ...
    <p class="login">Register To Login My Portfolio Website</p>
    <p class="garis"></p>
        <section class="container-fluid mb-4">
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="register.php" method="POST">
                    <h4 class="text-center font-weight-bold"> Register Portfolio </h4>
                    <?php if($error != ''){ ?>
                    ...
                    <div class="form-footer mt-2">
                        <p class="login-porto">Have an Account? <a href="login.php">Login</a></p>
                    </div>
                </form>
            </section>
            </section>
